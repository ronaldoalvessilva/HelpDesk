...
IF NOT EXISTS (SELECT NULL FROM SYSOBJECTS WHERE ID = OBJECT_ID('HISTORICO_COLABORADORES'))
	...
	Periodo_01 VARCHAR(80) NULL,	
	DataInicial_01 DATETIME NULL,	
	DataTermino_01 DATETIME NULL,	
	HorarioInicial_01 VARCHAR(20) NULL,
	HorarioTermino_01 VARCHAR(20) NULL,
	Periodo_02 VARCHAR(80) NULL,	
	DataInicial_02 DATETIME NULL,	
	DataTermino_02 DATETIME NULL,	
	HorarioInicial_02 VARCHAR(20) NULL,
	HorarioTermino_02 VARCHAR(20) NULL,
	Periodo_03 VARCHAR(80) NULL,	
	DataInicial_03 DATETIME NULL,	
	DataTermino_03 DATETIME NULL,	
	HorarioInicial_03 VARCHAR(20) NULL,
	HorarioTermino_03 VARCHAR(20) NULL,
	Periodo_04 VARCHAR(80) NULL,	
	DataInicial_04 DATETIME NULL,	
	DataTermino_04 DATETIME NULL,	
	HorarioInicial_04 VARCHAR(20) NULL,
	HorarioTermino_04 VARCHAR(20) NULL,
	)
	/*
	PERIODO 01 - MATUTINO
	PERIODO 02 - VESPERTINO
	PERIODO 03 - NOTURNO
	PERIODO 04 - ADMINISTRATIVO
	*/
