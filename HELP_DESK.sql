...
IF NOT EXISTS (SELECT NULL FROM SYSOBJECTS WHERE ID = OBJECT_ID('BIOMETRIA_USUARIOS'))
	...
	IF NOT EXISTS(SELECT 1 FROM SYSCOLUMNS WHERE ID = OBJECT_ID('USUARIOS') AND NAME = 'FotoUsuario')
       ALTER TABLE USUARIOS ADD FotoUsuario VARBINARY(MAX) NULL
