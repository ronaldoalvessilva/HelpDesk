...
IF NOT EXISTS(SELECT 1 FROM SYSCOLUMNS WHERE ID = OBJECT_ID('ITENS_CHAMADOS_SUPORTE') AND NAME = 'Utilizado')
   ALTER TABLE ITENS_CHAMADOS_SUPORTE ADD Utilizado VARCHAR(5) NULL
