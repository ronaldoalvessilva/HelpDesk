...
public class BiometriaColaboradores {
    ...
    private byte[] caminhoDigitalDedo1;
    private byte[] caminhoDigitalDedo2;
    private byte[] caminhoDigitalDedo3;
    private byte[] caminhoDigitalDedo4;
    ...
    public BiometriaColaboradores(int IdBioFunc, Date DataCadastro, int IdFunc, String nomeColabordor, String CaminhoImagemDedo1, String CaminhoImagemDedo2, String CaminhoImagemDedo3, String CaminhoImagemDedo4, byte[] BiometriaDedo1, byte[] BiometriaDedo2, byte[] BiometriaDedo3, byte[] BiometriaDedo4, byte[] caminhoDigitalDedo1, byte[] caminhoDigitalDedo2, byte[] caminhoDigitalDedo3, byte[] caminhoDigitalDedo4, String UsuarioInsert, String DataInsert, String HorarioInsert, String UsuarioUp, String DataUp, String HorarioUp) {
        ...
        this.caminhoDigitalDedo1 = caminhoDigitalDedo1;
        this.caminhoDigitalDedo2 = caminhoDigitalDedo2;
        this.caminhoDigitalDedo3 = caminhoDigitalDedo3;
        this.caminhoDigitalDedo4 = caminhoDigitalDedo4;
    ...
    /**
     * @return the caminhoDigitalDedo1
     */
    public byte[] getCaminhoDigitalDedo1() {
        return caminhoDigitalDedo1;
    }

    /**
     * @param caminhoDigitalDedo1 the caminhoDigitalDedo1 to set
     */
    public void setCaminhoDigitalDedo1(byte[] caminhoDigitalDedo1) {
        this.caminhoDigitalDedo1 = caminhoDigitalDedo1;
    }

    /**
     * @return the caminhoDigitalDedo2
     */
    public byte[] getCaminhoDigitalDedo2() {
        return caminhoDigitalDedo2;
    }

    /**
     * @param caminhoDigitalDedo2 the caminhoDigitalDedo2 to set
     */
    public void setCaminhoDigitalDedo2(byte[] caminhoDigitalDedo2) {
        this.caminhoDigitalDedo2 = caminhoDigitalDedo2;
    }

    /**
     * @return the caminhoDigitalDedo3
     */
    public byte[] getCaminhoDigitalDedo3() {
        return caminhoDigitalDedo3;
    }

    /**
     * @param caminhoDigitalDedo3 the caminhoDigitalDedo3 to set
     */
    public void setCaminhoDigitalDedo3(byte[] caminhoDigitalDedo3) {
        this.caminhoDigitalDedo3 = caminhoDigitalDedo3;
    }

    /**
     * @return the caminhoDigitalDedo4
     */
    public byte[] getCaminhoDigitalDedo4() {
        return caminhoDigitalDedo4;
    }

    /**
     * @param caminhoDigitalDedo4 the caminhoDigitalDedo4 to set
     */
    public void setCaminhoDigitalDedo4(byte[] caminhoDigitalDedo4) {
        this.caminhoDigitalDedo4 = caminhoDigitalDedo4;
    }
