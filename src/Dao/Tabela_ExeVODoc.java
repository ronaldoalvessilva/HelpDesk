 ...
 * @author ronal
 */
public class Tabela_ExeVODoc {

    ExeDAO dao = null;
    public static int count_PdfVODoc = 0;

    public void visualizar_PdfBeanDoc(JTable tabela) {
        ...
        if (get_Image("/Imagens/Download-16.png") != null) {
            icone = new ImageIcon(get_Image("/Imagens/Download-16.png"));
        }
        dao = new ExeDAO();
        PdfVO bean = new PdfVO();
        ArrayList<PdfVO> list = dao.ListarDoc_ExeVO();
        ...
        if (list.size() > 0) {
            ...
            for (int i = 0; i < list.size(); i++) {  
                ...
                count_PdfVODoc = count_PdfVODoc + 1;
                dt.addRow(fila);
            }
