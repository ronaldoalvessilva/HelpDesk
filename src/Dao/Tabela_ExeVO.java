 ...
 * @author ronal
 */
public class Tabela_ExeVO {

    ExeDAO dao = null;
    public static int count_ExeVO = 0;

    public void visualizar_ExeBean(JTable tabela) {
        ...
        ArrayList<PdfVO> list = dao.Listar_ExeVO();
