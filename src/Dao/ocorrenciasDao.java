...
public class ocorrenciasDao {
    ...
    Ocorrencias objOcorr = new Ocorrencias();

    public Ocorrencias incluirOcorrenciaP1(Ocorrencias objOcorr) {
    ...
    public Ocorrencias alterarOcorrenciaP1(Ocorrencias objOcorr) {
    ...
    public Ocorrencias excluirOcorrenciaP1(Ocorrencias objOcorr) {
    ...
    public Ocorrencias finalizarOcorrenciaP1(Ocorrencias objOcorr) {
