...
public class Tabela_PdfVODoc {
    ...
    public void visualizar_PdfBeanDoc(JTable tabela) {
        ...
        if (get_Image("/Imagens/Pdf16.png") != null) {
            icone = new ImageIcon(get_Image("/Imagens/Pdf16.png"));
        }
        dao = new PdfDAO();
        PdfVO bean = new PdfVO();
        ArrayList<PdfVO> list = dao.ListarDoc_PdfVO();
