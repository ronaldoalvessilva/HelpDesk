...
import static Visao.TelaRecadosCliente.jNomeDestinatario;
 ...
 * @author ronaldo
 */
public class TelaPesqAgendaCliente extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jBtPesqNomeUsuario.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/Lupas_1338_05.gif"))); // NOI18N
        ...
        if (jTabelaUsuarios.getColumnModel().getColumnCount() > 0) {
            ...
            jTabelaUsuarios.getColumnModel().getColumn(1).setMinWidth(80);
            jTabelaUsuarios.getColumnModel().getColumn(1).setMaxWidth(80);
            jTabelaUsuarios.getColumnModel().getColumn(2).setMinWidth(290);
            jTabelaUsuarios.getColumnModel().getColumn(2).setMaxWidth(290);
        }
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        // TODO add your handling code here:
        if (flag == 1) {
            String nomeUsuario = "" + jTabelaUsuarios.getValueAt(jTabelaUsuarios.getSelectedRow(), 2);
            jNomeUsuario.setText(nomeUsuario);
            conecta.abrirConexao();
            try {
                conecta.executaSQL("SELECT * FROM USUARIOS "
                        + "WHERE NomeUsuario='" + jNomeUsuario.getText() + "'");
                conecta.rs.first();
    ...
    public void preencherTabelaUsuario(String sql) {
        ...
        String[] Colunas = new String[]{"Código","Status", "Nome do Usuário", };
        conecta.abrirConexao();
        conecta.executaSQL(sql);
        try {
            conecta.rs.first();
            do {
                dados.add(new Object[]{conecta.rs.getInt("IdUsuario"), conecta.rs.getString("StatusUsuario"), conecta.rs.getString("NomeUsuario")});
        ...
        jTabelaUsuarios.getColumnModel().getColumn(1).setPreferredWidth(80);
        jTabelaUsuarios.getColumnModel().getColumn(1).setResizable(false);
        jTabelaUsuarios.getColumnModel().getColumn(2).setPreferredWidth(290);
