 ...
 * @author user
 */
public class TelaPesquisaEmpresaUnidade extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesquisaEmpresaUnidade() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        if (jTabelaEmpresas.getColumnModel().getColumnCount() > 0) {
            jTabelaEmpresas.getColumnModel().getColumn(0).setMinWidth(70);
            jTabelaEmpresas.getColumnModel().getColumn(0).setMaxWidth(70);
    ...
    private void jBtPesqNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqNomeActionPerformed
        ...
        if (jPesqRazaoSocial.getText().equals(evt)) {
            ...
            pesquisarEmpresasLaborativas("SELECT * FROM EMPRESA "
                    + "WHERE EMPRESA.RazaoSocial LIKE'%" + jPesqRazaoSocial.getText() + "%' "
                    + "AND EMPRESA.StatusFor='" + statusEmp + "'");
        }
    ...
    private void jCheckBoxTodosItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxTodosItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.pesquisarEmpresasLaborativas("SELECT * FROM EMPRESA "
                    + "WHERE EMPRESA.StatusFor='" + statusEmp + "'");
        } else {
            limparTabela();
        }
    ...
    private void jBtConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtConfirmarActionPerformed
        ...
        flag = 1;
        if (flag == 1) {
//            String idUnid = "" + jTabelaPesqEmpresas.getValueAt(jTabelaPesqEmpresas.getSelectedRow(), 2);
            String rezaoSocial = "" + jTabelaEmpresas.getValueAt(jTabelaEmpresas.getSelectedRow(), 1);
            ...
            try {
                conecta.executaSQL("SELECT * FROM EMPRESA "
                        + "WHERE EMPRESA.RazaoSocial='" + rezaoSocial + "' "
                        + "AND EMPRESA.IdEmpresa='" + idEmp + "'");
                conecta.rs.first();
    ...
    private void jTabelaEmpresasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaEmpresasMouseClicked
        ...
        flag = 1;
        if (flag == 1) {
            nomeVisita = "" + jTabelaEmpresas.getValueAt(jTabelaEmpresas.getSelectedRow(), 1);
            jPesqRazaoSocial.setText(nomeVisita);
            idInt = "" + jTabelaEmpresas.getValueAt(jTabelaEmpresas.getSelectedRow(), 0);
        }
    ...
    public void pesquisarEmpresasLaborativas(String sql) {
        ...
        String[] Colunas = new String[]{"Código", "Razão Social"};
        conecta.abrirConexao();
        conecta.executaSQL(sql);
        try {
            conecta.rs.first();
            do {
                dados.add(new Object[]{conecta.rs.getInt("IdEmpresa"), conecta.rs.getString("RazaoSocial")});
        ...
        jTabelaEmpresas.getColumnModel().getColumn(0).setPreferredWidth(70);
