...
public class TelaChamadoSuporte extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel8Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jBtAnexarArquivo, jBtEXE, jBtEncerrar, jBtEnviar, jBtImprimir, jBtReabrir, jBtSair});
        ...
        jPanel9Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jBtAlterar, jBtCancelar, jBtExcluir, jBtNovo, jBtSalvar, jToggleButtonStatus});
...
//                            pTOTAL_REGISTROS_EM_atendimento = 0;
    ...
    private void jBtAnexarArquivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAnexarArquivoActionPerformed
        ...
        if (jIdChamado.getText().equals("")) {
            ...
            JOptionPane.showMessageDialog(rootPane, "Não existe texto descrevendo o problema a ser resolvido.");
        } else {
            mostrarPdf();
        }
