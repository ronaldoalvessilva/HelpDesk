...
import static Visao.TelaAtendentesSuporte.jIdAtendente;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaAtendente extends javax.swing.JInternalFrame {
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ATENDENTES WHERE IdAtendente='" + jIdAtendente.getText() + "'");
            conecta.rs.first();
