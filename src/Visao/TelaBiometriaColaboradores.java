...
import Dao.BiometriaColaboradoresDao;
...
import static Visao.TelaUsuarios.jNomeUsuario;
...
public class TelaBiometriaColaboradores extends javax.swing.JDialog {
    ...
    BiometriaColaboradoresDao CONTROL = new BiometriaColaboradoresDao();
    //
    public static String codigoColaborador;
    Date dataFormatada;
    // MÃO DIREITA
    ...
    public static String caminhoBiometria1 = "";
    public static String caminhoBiometria2 = "";
    public static String caminhoBiometria3 = "";
    public static String caminhoBiometria4 = "";
    // CAMINHO DAS DIGITAIS PARA GRAVAR NO BANCO DADOS;
    public static String caminhoImagemDigital1 = "";
    public static String caminhoImagemDigital2 = "";
    public static String caminhoImagemDigital3 = "";
    public static String caminhoImagemDigital4 = "";
    //
    ...
    public static TelaUsuarios pTELA_usuarios;

    /**
     * Creates new form TelaBiometriaInterno
     */
    public TelaBiometriaColaboradores(TelaUsuarios parent, boolean modal) {
        this.pTELA_usuarios = parent;
        this.setModal(modal);
        setLocationRelativeTo(pTELA_usuarios);
        initComponents();
        corCampos();
        dadosColaborador();
//        buscarCaminhoTempleteImagem();
    ...
    private void initComponents() {
        ...
        jCodigoUsuario = new javax.swing.JTextField();
        jNomeUsuarioBiometria = new javax.swing.JTextField();
        ...
        jCodigoUsuario.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        jCodigoUsuario.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED));
        jCodigoUsuario.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        jCodigoUsuario.setEnabled(false);

        jNomeUsuarioBiometria.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED));
        jNomeUsuarioBiometria.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        jNomeUsuarioBiometria.setEnabled(false);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jCodigoUsuario, javax.swing.GroupLayout.PREFERRED_SIZE, 57, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel2))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jLabel1)
                            .addComponent(jNomeUsuarioBiometria, javax.swing.GroupLayout.DEFAULT_SIZE, 323, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    ...
                    .addComponent(jNomeUsuarioBiometria, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jCodigoUsuario, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void jBtDedo1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtDedo1ActionPerformed
        ...
        File fileImagem1 = new File(caminhoBiometria1 + jCodigoUsuario.getText() + "-" + jNomeUsuarioBiometria.getText() + "-Digital1-MD" + ".gif");
        fileImagem1.delete();
        // Gravar a digital em um arquivo
        File arquivo2 = new File(caminhoBiometria1 + jCodigoUsuario.getText() + "-" + jNomeUsuarioBiometria.getText() + "-Digital1-MD" + ".gif");
        ...
        try {
            ...
            imagem1 = ImageIO.read(new File(caminhoBiometria1 + jCodigoUsuario.getText() + "-" + jNomeUsuarioBiometria.getText() + "-Digital1-MD" + ".gif"));
            ...
            //
            caminhoImagemDigital1 = caminhoBiometria1 + jCodigoUsuario.getText() + "-" + jNomeUsuarioBiometria.getText() + "-Digital1-MD" + ".gif";
        } catch (Exception e) {
        }
    ...
    private void jBtDedo2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtDedo2ActionPerformed
        ...
        // APAGAR A IMAGEM ANTERIOR
        File fileImagem2 = new File(caminhoBiometria2 + jCodigoUsuario.getText() + "-" + jNomeUsuarioBiometria.getText() + "-Digital2-MD" + ".gif");
        fileImagem2.delete();
        // Gravar a digital em um arquivo
        File arquivo2 = new File(caminhoBiometria2 + jCodigoUsuario.getText() + "-" + jNomeUsuarioBiometria.getText() + "-Digital2-MD" + ".gif");
        try (FileOutputStream arq = new FileOutputStream(arquivo2)) {
        ...
        try {
            ...
            imagem2 = ImageIO.read(new File(caminhoBiometria2 + jCodigoUsuario.getText() + "-" + jNomeUsuarioBiometria.getText() + "-Digital2-MD" + ".gif"));
            ...
            caminhoImagemDigital2 = caminhoBiometria2 + jCodigoUsuario.getText() + "-" + jNomeUsuarioBiometria.getText() + "-Digital2-MD" + ".gif";
        } catch (Exception e) {
        }
    ...
    private void jBtDedo3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtDedo3ActionPerformed
        ...
        // APAGAR A IMAGEM ANTERIOR
        File fileImagem3 = new File(caminhoBiometria3 + jCodigoUsuario.getText() + "-" + jNomeUsuarioBiometria.getText() + "-Digital3-ME" + ".gif");
        fileImagem3.delete();
        // Gravar a digital em um arquivo
        File arquivo3 = new File(caminhoBiometria3 + jCodigoUsuario.getText() + "-" + jNomeUsuarioBiometria.getText() + "-Digital3-ME" + ".gif");
        ...
        try {
            ...
            imagem3 = ImageIO.read(new File(caminhoBiometria3 + jCodigoUsuario.getText() + "-" + jNomeUsuarioBiometria.getText() + "-Digital3-ME" + ".gif"));
            ...
            //
            caminhoImagemDigital3 = caminhoBiometria3 + jCodigoUsuario.getText() + "-" + jNomeUsuarioBiometria.getText() + "-Digital3-ME" + ".gif";
        } catch (Exception e) {
        }
    ...
    private void jBtDedo7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtDedo7ActionPerformed
        ...
        // APAGAR A IMAGEM ANTERIOR
        File fileImagem4 = new File(caminhoBiometria4 + jCodigoUsuario.getText() + "-" + jNomeUsuarioBiometria.getText() + "-Digital4-ME" + ".gif");
        fileImagem4.delete();
        // Gravar a digital em um arquivo
        File arquivo6 = new File(caminhoBiometria4 + jCodigoUsuario.getText() + "-" + jNomeUsuarioBiometria.getText() + "-Digital4-ME" + ".gif");
        ...
        try {
            ...
            imagem4 = ImageIO.read(new File(caminhoBiometria4 + jCodigoUsuario.getText() + "-" + jNomeUsuarioBiometria.getText() + "-Digital4-ME" + ".gif"));
            ...
            //
            caminhoImagemDigital4 = caminhoBiometria4 + jCodigoUsuario.getText() + "-" + jNomeUsuarioBiometria.getText() + "-Digital4-ME" + ".gif";
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        ...
        if (jComboBoxOpcao.getSelectedItem().equals("Selecione...")) {
            ...
            if (jComboBoxOpcao.getSelectedItem().equals("Cadastrar Biometria") && !jCodigoUsuario.getText().equals(codigoColaborador)) {
                if (capDigital1 != null && capDigital2 != null && capDigital3 != null && capDigital4 != null) {
                    objBio.setIdFunc(Integer.valueOf(jCodigoUsuario.getText()));
                    objBio.setNomeColabordor(jNomeUsuarioBiometria.getText());
            ...
            } else if (jComboBoxOpcao.getSelectedItem().equals("Alterar Biometria") && jCodigoUsuario.getText().equals(codigoColaborador)) {
            ...
            } else if (jComboBoxOpcao.getSelectedItem().equals("Cadastrar Biometria") && jCodigoUsuario.getText().equals(codigoColaborador)) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaBiometriaColaboradores dialog = new TelaBiometriaColaboradores(pTELA_usuarios, true);
    ...
    private javax.swing.JTextField jCodigoUsuario;
    ...
    private javax.swing.JTextField jNomeUsuarioBiometria;
    ...
    public void buscarCaminhoTempleteImagem() {
        CONTROL.BUSCAR_CAMINHO_TEMPLATE_Imagem(objBio);
    }

    public void corCampos() {
        jCodigoUsuario.setBackground(Color.white);
        jNomeUsuarioBiometria.setBackground(Color.white);
    ...
    public void dadosColaborador() {
        if (caminhoFotoFunc != null) {
            ...
            jFotoUsuario.setIcon(z);
            jFotoUsuario.setIcon(new ImageIcon(z.getImage().getScaledInstance(jFotoUsuario.getWidth(), jFotoUsuario.getHeight(), Image.SCALE_DEFAULT)));
        }
        jCodigoUsuario.setText(jIdUsuario.getText());
        jNomeUsuarioBiometria.setText(jNomeUsuario.getText());
    }

    public void verificarColaboradorBiometria() {
        CONTROL.VERIFICAR_BIOMETRIA_usuario(objBio);
    }
    ...
    public void lerDigitaisCadastradas() {
        ...
        try {
            BufferedImage imagem1;
            imagem1 = ImageIO.read(new File(caminhoBiometria1 + jIdUsuario.getText() + "-" + jNomeUsuarioBiometria.getText() + "-Digital1-MD" + ".gif"));
        ...
        try {
            BufferedImage imagem2;
            imagem2 = ImageIO.read(new File(caminhoBiometria2 + jIdUsuario.getText() + "-" + jNomeUsuarioBiometria.getText() + "-Digital2-MD" + ".gif"));
            javax.swing.ImageIcon b = new javax.swing.ImageIcon(imagem2);
            jFotoIndicadorDireito.setIcon(b);
            jFotoIndicadorDireito.setIcon(new ImageIcon(b.getImage().getScaledInstance(jFotoIndicadorDireito.getWidth(), jFotoIndicadorDireito.getHeight(), Image.SCALE_DEFAULT)));
        } catch (Exception e) {
        ...
        try {
            BufferedImage imagem3;
            imagem3 = ImageIO.read(new File(caminhoBiometria3 + jIdUsuario.getText() + "-" + jNomeUsuarioBiometria.getText() + "-Digital3-ME" + ".gif"));
        ...
        try {
            BufferedImage imagem4;
            imagem4 = ImageIO.read(new File(caminhoBiometria4 + jIdUsuario.getText() + "-" + jNomeUsuarioBiometria.getText() + "-Digital4-ME" + ".gif"));
