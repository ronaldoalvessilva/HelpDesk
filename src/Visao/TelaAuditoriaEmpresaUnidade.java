...
import static Visao.TelaEmpresa.jIdUnidade;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaEmpresaUnidade extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaEmpresaUnidade() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Unidade Penal :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM UNIDADE_PENAL_EMPRESA "
                    + "WHERE IdUnidEmp='" + jIdUnidade.getText() + "' "
                    + "AND IdEmpresa='" + jIdEmpresa.getText() + "'");
            conecta.rs.first();
