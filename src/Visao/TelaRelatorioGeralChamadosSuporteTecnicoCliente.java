 ...
 */
public class TelaRelatorioGeralChamadosSuporteTecnicoCliente extends javax.swing.JInternalFrame {
     ...
     */
    public TelaRelatorioGeralChamadosSuporteTecnicoCliente() {
        initComponents();
    }
            ...
            Thread t = new Thread() { //Teste tela aguarde
                public void run() { //Teste
                    try {
                        ...
                        String path = "reports/RelatorioChamadosSuportePorUsuario.jasper";
                        conecta.executaSQL("SELECT "
                                ...
                                + "AND USUARIOS.NomeUsuario='" + nameUser + "'");
