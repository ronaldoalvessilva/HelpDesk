 ...
 * @author Ronaldo
 */
public class TelaAuditoriaSolicitantes extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaSolicitantes() {
        initComponents();
        auditoria();      
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria  Solicitantes :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM SOLICITANTES WHERE IdSolicitante='" + jIdSolicitante.getText() + "'");
            conecta.rs.first();
