 ...
 * @author Ronaldo
 */
public class TelaWebCamColaborador extends javax.swing.JDialog {

    ConexaoBancoDados conecta = new ConexaoBancoDados();

    String localFotoColaborador = "";
     ...
     * @param modal
     */
    public static TelaUsuarios telaWebCamFunc;

    //TESTADO E FUNCIONANDO NO DIA 02/12/2016 - EM VITÓRIA DA CONQUISTA
    public TelaWebCamColaborador(TelaUsuarios parent, boolean modal) {
        this.telaWebCamFunc = parent;
        this.setModal(modal);
        setLocationRelativeTo(telaWebCamFunc);
        initComponents();
...
//        localFotoFunc();
        if (pLOCAL_foto == null || pLOCAL_foto == "") {
            ...
            if (acao == JFileChooser.APPROVE_OPTION) {
                ...
                if (f.getPath().endsWith("jpg") || f.getPath().endsWith("JPG")) {
                    ...
                    jFotoUsuario.setIcon(i);
                    ImageIcon image = new ImageIcon(seletor.getSelectedFile().getPath());
                    jFotoUsuario.setIcon(new ImageIcon(image.getImage().getScaledInstance(jFotoUsuario.getWidth(), jFotoUsuario.getHeight(), Image.SCALE_DEFAULT)));
                    caminhoFotoFunc = f.getPath();
            ...
            javax.swing.JFileChooser seletor = new javax.swing.JFileChooser(localFotoColaborador);
            FileNameExtensionFilter tipoExtensao = new FileNameExtensionFilter("Imagem de Foto", "jpg", "bmp", "gif", "png");
            seletor.setAcceptAllFileFilterUsed(false);
            seletor.setMultiSelectionEnabled(false);
            seletor.setFileFilter(tipoExtensao);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaWebCamColaborador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaWebCamColaborador dialog = new TelaWebCamColaborador(telaWebCamFunc, true);
