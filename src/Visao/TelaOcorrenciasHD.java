 ...
 * @author ronaldo
 */
public class TelaOcorrenciasHD extends javax.swing.JInternalFrame {

    ConexaoBancoDados conecta = new ConexaoBancoDados();
    Ocorrencias objOcorr = new Ocorrencias();
    ocorrenciasDao control = new ocorrenciasDao();
    ...
    private void initComponents() {
        ...
        setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/page_white_word.png"))); // NOI18N
        ...
        jBtPesqTituloOcorrrencia.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/Lupas_1338_05.gif"))); // NOI18N
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jStatusOcorrencia, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jBtImpressao.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/gtklp-icone-3770-16.png"))); // NOI18N
        ...
        jBtPDF.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/Pdf16.png"))); // NOI18N
        ...
        jPanel10Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel10Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jComboBoxCorFonte, 0, 184, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jBtEsquerda.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/esquerda.png"))); // NOI18N
        ...
        jBtCentralizar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/Centralizado.png"))); // NOI18N
        ...
        jBtDireita.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/direita.png"))); // NOI18N
        ...
        jBtJustificar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/justificado.png"))); // NOI18N
        ...
        jBtFinalizar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/40_16x16.png"))); // NOI18N
        ...
        setBounds(300, 10, 547, 516);
    }// </editor-fold>//GEN-END:initComponents

    private void jBtNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaOcorrenciaManu);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || codigoUser == codUserAcesso && nomeTela.equals(telaOcorrenciaManu) && codIncluir == 1) {
            acao = 1;
            Novo();
            loadFont();
            corCampos();
    ...
    private void jBtAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaOcorrenciaManu);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || codigoUser == codUserAcesso && nomeTela.equals(telaOcorrenciaManu) && codAlterar == 1) {
    ...
    private void jBtExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaOcorrenciaManu);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || codigoUser == codUserAcesso && nomeTela.equals(telaOcorrenciaManu) && codExcluir == 1) {
            statusMov = "Excluiu";
            horaMov = jHoraSistema.getText();
            dataModFinal = jDataSistema.getText();
            objOcorr.setStatusLanc(jStatusOcorrencia.getText());
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaOcorrenciaManu);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || codigoUser == codUserAcesso && nomeTela.equals(telaOcorrenciaManu) && codGravar == 1) {
    ...
    private void jBtAuditoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaOcorrencias objAudiOcorre = new TelaAuditoriaOcorrencias();
        jPainelPrincipal.add(objAudiOcorre);
        objAudiOcorre.show();
    ...
    private void jBtPesqCodigoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqCodigoActionPerformed
        ...
        if (jCodigo.getText().equals("")) {
            ...
            pesquisarOcorrrencias("SELECT * FROM OCORRENCIAS_P1 "
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.pesquisarOcorrrencias("SELECT * FROM OCORRENCIAS_P1");
        } else {
    ...
    private void jBtPesqTituloOcorrrenciaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jBtPesqTituloOcorrrenciaMouseClicked
        ...
        if (jPesqTituloOcorrencia.getText().equals("")) {
            ...
            pesquisarOcorrrencias("SELECT * FROM OCORRENCIAS_P1 WHERE WHERE Titulo "
